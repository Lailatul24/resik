                ...
                Container(
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: Row(
                          children: <Widget>[Text('Rp.20.000'), Text('30 X')],
                        ),
                      )
                    ],
                  ),
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [Text('Jual'), Text('Rp 35.000')],
                      ),
                    ),
                    Container(
                      color: Colors.white,
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [Text('Total :'), Text('34.500')],
                      ),
                    ),
                    Container(
                      width: MediaQuery.of(context).size.width,
