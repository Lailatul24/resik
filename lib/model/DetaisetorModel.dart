...
//
//     final getDetailsetor = getDetailsetorFromMap(jsonString);

import 'dart:convert';

class GetDetailsetor {
    GetDetailsetor({
        this.hasil,
        this.message,
    });
    ...
    factory GetDetailsetor.fromJson(String str) => GetDetailsetor.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory GetDetailsetor.fromMap(Map<String, dynamic> json) => GetDetailsetor(
        hasil: json["hasil"],
...
class Message {
    ...
    factory Message.fromMap(Map<String, dynamic> json) => Message(
        ...
        kode: json["Kode"],
        status: json["Status"],
        setoran: List<Setoran>.from(json["Setoran"].map((x) => Setoran.fromMap(x))),
...
class NamaNasabah {
    ...
    factory NamaNasabah.fromJson(String str) => NamaNasabah.fromMap(json.decode(str));
